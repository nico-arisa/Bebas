...
function CardBody() {
  ...
  return (
    ...
    <div className='d-grid' style={{justifyContent:'space-around', alignItems:'center', margin:'80px', gridTemplateColumns:'auto auto auto'}}>
        {trip?.map((card,index) => (
            <div className="card position-relative" style={{width: '350px', height:'350px', marginTop:'50px'}} key={index}>
                <div className="card-body" style={{padding:'0', paddingTop:'10px'}}>
                  ...
                  <h6 className="card-subtitle mb-2 text-warning" style={{fontWeight:'bold'}}>IDR {card.price} </h6>
